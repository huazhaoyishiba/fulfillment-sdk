-- SDK 核心表结构（达梦数据库 DM 版本）
-- 适用于 DM 7 / DM 8
-- 达梦数据库兼容 Oracle 语法，本脚本基于 Oracle 版本调整

-- ==================== 序列 ====================

CREATE SEQUENCE sdk_payment_record_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE sdk_idempotent_record_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE sdk_fulfillment_task_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE sdk_fulfillment_log_seq START WITH 1 INCREMENT BY 1;
...
CREATE TABLE sdk_fulfillment_task (
    ...
    action_code VARCHAR(32) DEFAULT 'GRANT' NOT NULL,
    benefit_config_snapshot CLOB NOT NULL,
    status VARCHAR(32) NOT NULL,
    retry_count INT DEFAULT 0 NOT NULL,
    max_retry_count INT DEFAULT 3 NOT NULL,
